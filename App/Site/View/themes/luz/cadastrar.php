...
<main class="main">
    ...
    <section class="main_section_new">
        ...
        <section class="login">
            <form action="<?= URL ?>/user/cadastrando" method="POST">
                <header>
                ...
                <div class="form_div">
                    ...
                    <input type="text" id="last_name" name="last_name" placeholder="Sobre nome" >
                </div>
                <div class="form_div">
                ...
                <div class="form_div_phone">
                    ...
                    <div class="form_div_tel">

                        <input type="text" id="phone" maxlength="9" name="phone" placeholder="Telefone">
                    </div>
                </div>
                ...
                <div class="form_div_opt">
                    <a href="<?= URL ?>/user/login">Fazer login</a><a href="<?= URL ?>/user/recuperarsenha.html">Esqueci senha</a>
                </div>
            </form>
        </section>
